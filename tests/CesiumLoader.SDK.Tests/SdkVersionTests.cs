...
namespace CesiumLoader.SDK.Tests
{
    ...
    public class SdkVersionTests
    {
        ...
        public void Current_MatchesReleaseLine()
        {
            ...
            Assert.Equal("2.2.1", SdkVersion.Current);
            Assert.Equal("2.2.1", SdkVersion.LoaderVersion);
        }
        ...
        {
            // 与当前版本相同 → 兼容（SDK 2.2.1 接受声明 2.2.1 的 mod）
        ...
        /// <summary>把指定段 +1、更低的段归零(2.2.1 的 revision → 2.2.1, minor → 2.2.1, major → 3.0.0)。</summary>
